...
xhttp.open("GET", "https://srivat2001.github.io/pinacle20kk/details.json", true);
xhttp.send();
...
class events {
    ...
    adddsubmitbtn() {
        var str = '<form action="eventregister.html" onsubmit="return register(\'' + type + '\')" methon="post"><button name="eventname"  eventtype="' + type + '" value="' + this.name + '" class="cyberpunk2077 btnsubmit">Register</button></form>';
        this.htmlholder.innerHTML = this.htmlholder.innerHTML + str;
    }
